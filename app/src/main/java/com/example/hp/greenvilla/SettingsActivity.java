...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        securityQuestionBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(com.example.hp.greenvilla.SettingsActivity.this, com.example.hp.greenvilla.ResetPasswordActivity.class);
        ...
        profileChangeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                CropImage.activity(imageUri)
                        .setAspectRatio(1, 1)
                        .start(com.example.hp.greenvilla.SettingsActivity.this);
            }
        });
    }
    ...
    private void updateOnlyUserInfo()
    {
        ...
        startActivity(new Intent(com.example.hp.greenvilla.SettingsActivity.this, com.example.hp.greenvilla.HomeActivity.class));
        Toast.makeText(com.example.hp.greenvilla.SettingsActivity.this, "Profile Info update successfully.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        else
        {
            ...
            startActivity(new Intent(com.example.hp.greenvilla.SettingsActivity.this, com.example.hp.greenvilla.SettingsActivity.class));
            finish();
        }
    }
                ...
                public Object then(@NonNull Task task) throws Exception
                {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            ...
                            {
                                progressDialog.dismiss();
                                Toast.makeText(com.example.hp.greenvilla.SettingsActivity.this, "Error.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
