    ...
    private void ValidateUser(final String name, final String number, final String password, final String parentDbName)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    RootRef.child(parentDbName).child(number).setValue(user)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        Toast.makeText(com.example.hp.greenvilla.RegisterUserActivity.this, "Congratulations, your account has been created.", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();

                                        Intent intent = new Intent(com.example.hp.greenvilla.RegisterUserActivity.this, LoginActivity.class);
                                        startActivity(intent);
                                    }
                                    else
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(com.example.hp.greenvilla.RegisterUserActivity.this, "Network Error: Please try again after some time...", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
                ...
                {
                    Toast.makeText(com.example.hp.greenvilla.RegisterUserActivity.this, "This " + number + " already exists.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();

                    Intent intent = new Intent(com.example.hp.greenvilla.RegisterUserActivity.this, MainActivity.class);
                    startActivity(intent);
                }
            }
